...
namespace Music.db
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //options.UseSqlServer(Configuration.GetConnectionString("SqlBakerConnection")));
            options.UseSqlServer(Configuration.GetConnectionString("MusicdbLocalDbConnection")));
        ...
        private async Task CreateRoles(IServiceProvider serviceProvider)
        {
            ...
            MusicDbContext context = serviceProvider.GetRequiredService<MusicDbContext>();
